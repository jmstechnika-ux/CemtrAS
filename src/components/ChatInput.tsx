    ...
    <form onSubmit={handleSubmit} className="flex gap-2 sm:gap-4">
      <div className="flex-1 relative">
        <input
          ...
          disabled={isLoading}
          className="w-full px-4 sm:px-6 py-3 sm:py-4 bg-slate-50 border-2 sm:border-4 border-slate-300 rounded-xl sm:rounded-2xl
        ...
        <button
          type="button"
          className="absolute right-12 sm:right-16 top-1/2 transform -translate-y-1/2 p-2 text-slate-400 hover:text-slate-600 transition-colors"
        >
      ...
      <button
        ...
        className="px-4 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-yellow-500 to-yellow-600 text-white rounded-xl sm:rounded-2xl 
